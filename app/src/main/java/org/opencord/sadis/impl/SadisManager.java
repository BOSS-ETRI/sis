...
import org.etri.sis.BandwidthProfileInformation;
...
public class SadisManager implements SadisService {
    ...
    private static final String SADIS_APP = "org.etri.sis";
    ...
    private SliceProfileManager sliceProfileManager;
    ...
    protected void activate() {
        ...
        sliceProfileManager = new SliceProfileManager(appId);

        internalServices.add(subscriberManager);
        internalServices.add(bandwidthProfileManager);
        internalServices.add(sliceProfileManager);
    ...
    @Override
    public BaseInformationService<SliceProfileInformation> getSliceProfileService() {
        return sliceProfileManager;
    }
